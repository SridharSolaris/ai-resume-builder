...
function ResumeCardItem({ resume, refreshData }) {
    ...
    return (
        ...
        items-center justify-center h-[180px] '>
            ...
            <div className='border p-3 flex justify-between items-center  text-white rounded-b-lg shadow-lg'
                style={{
                    background: resume?.attributes.themeColor
                }}>
                <h2 className='text-sm font-semibold'>{resume.attributes.title}</h2>

                <DropdownMenu>
                    <DropdownMenuTrigger className='bg-inherit'>
